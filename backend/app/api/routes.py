...
def prioritized_invoices(
    ...
    latest_subq = (
        select(
            ...
            func.max(PrediccionFactura.created_at).label("max_created_at"),
        )
        .group_by(PrediccionFactura.factura_id)
        .subquery()
    )
    stmt = (
        ...
        .join(
            PrediccionFactura,
            (PrediccionFactura.factura_id == latest_subq.c.factura_id)
            & (PrediccionFactura.created_at == latest_subq.c.max_created_at),
        )
